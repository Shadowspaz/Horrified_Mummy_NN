...
public class Matrix
{
    ...
    // Allows setting all values on matrix creation
    ...
    // Simplified getters for width/height
...
public class NeuralNetwork
{
    ...
    // Copy all values from one Neuralnetwork into another
    ...
    // Neuron activation function, applied to matrices
    ...
    // Basic neuron activation function
    ...
    // Fully randomized all weights, instead of mutating. Used on initial generation
